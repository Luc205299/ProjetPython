...
while Interface < 0 or Interface > 4 or Interface is not None:
    ...
    input(text_Userinterface)))
                while userinterface < 16 or Interface > 1 or Interface is None:
                    userinterface = int(
                    input(text_Userinterface))
                match userinterface:
